...
import com.ragservice.rag.domain.DocumentChunk.ChunkResult;
import com.ragservice.rag.dto.MessageDto;
import com.ragservice.rag.repository.DocumentChunkRepository;
...
public class RagService {
    ...
    public RagResult chat(String userMessage, List<MessageDto> history) {
        ...
        // 3. pgvector 검색 (access_groups && ARRAY['all'])
