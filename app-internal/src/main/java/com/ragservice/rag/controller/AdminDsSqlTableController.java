 ...
 * /api/v1/admin/datasources/{dsId}/sql-tables
 */
@Slf4j
@RestController
@RequestMapping("/api/v1/admin/datasources/{dsId}/sql-tables")
...
public class AdminDsSqlTableController {
     ...
     * LLM을 단 1회 호출해 전체 테이블의 데이터 민감도를 자동 분류.
     * restricted 판정 테이블은 SQL 경로 등록 불가 → skipped 처리.
     */
    ...
    public ResponseEntity<BulkImportResult> bulkImport(
        ...
        // 즉시 등록 (internal 기본값, llmStatus=pending)
