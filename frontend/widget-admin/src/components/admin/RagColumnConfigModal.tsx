...
function parseColumns(arr: string[] | undefined, json: string | undefined): string[] {
...
export default function RagColumnConfigModal({ dsId, table, onSaved, onClose }: Props) {
  ...
  const [contentColumns, setContentColumns] = useState<string[]>(
    parseColumns(table.contentColumns, table.contentColumnsJson),
  )
  const [metadataColumns, setMetadataColumns] = useState<string[]>(
    parseColumns(table.metadataColumns, table.metadataColumnsJson),
  )
