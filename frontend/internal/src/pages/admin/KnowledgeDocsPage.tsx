...
import {
  ...
  isTextFile,
  extOf,
} from '../../api/admin/knowledgeDocs'
import type { KnowledgeFileInfo } from '../../api/admin/knowledgeDocs'
...
export default function KnowledgeDocsPage() {
  ...
  const createMut = useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: ['admin-knowledge-docs'] }); closeModal() },
  ...
  const deleteMut = useMutation({
    ...
    onSuccess: () => qc.invalidateQueries({ queryKey: ['admin-knowledge-docs'] }),
    onError: (err: unknown) => setErrorMsg(errMsg(err)),
  })
